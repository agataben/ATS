The file NAR_functions.py contains useful functions to apply the NHAR methodology.

The file rob_functions.py contains useful functions to apply the COM and HAR methodologies.

The file demo.py presents an end to end test to see how the COM, HAR and NHAR methodologies perform anomaly detection for a simulated dataset generated according with the attached paper.
