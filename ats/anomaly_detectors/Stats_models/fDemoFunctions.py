...
from fRobFunctions   import (fRobResiduals,fCOM, fARcorsi)
from fNARfunctions import fNHAR
...
def fSimContaminatedSeries(cn,cd,prct=0.4,cnj= np.array([80, 100, 120]),outlier='addout',tim=5,seas=7):
    '''
